...
The version of your *federator* installation should be displayed. When you are
done with your tests do not forget to deactivate the virtual environment:
...
.. code::
  ...
  $ eida-federator --start-local --tmpdir='/path/to/tmp'
